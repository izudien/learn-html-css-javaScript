...
function once(func) {
  ...
  function returnFunc(num) {
    // onceFunc(4) call first time = result = 0;counter = 0;
    //  counter === 0 true; counter = 1; func(num) call,result = 6; counter = 1;
    // onceFunc(10) call second time = result = 6 ; counter = 1;
    // false -> return result= 6
    // onceFunc(9001) call third time = result = 6 ; counter = 1;
    // false -> return result= 6
    if (counter === 0) {
      counter++; // when returnFunc is called first time,'counter is increament making value 1
...
function after(count, func) {
  ...
  function innerCalled() {
    ...
    if (counter === count) {
      ...
      console.log(`not called because counter is: ${counter}`);
    }
  }
...
const called = function () {
  console.log("hello, function has been called");
};
